...
import { GROUP_COLORS, type Group, type GroupColor } from '@/types/group';
...
export function EditGroupDialog({ open, group, onClose, onSuccess, language = 'zh' }: EditGroupDialogProps) {
